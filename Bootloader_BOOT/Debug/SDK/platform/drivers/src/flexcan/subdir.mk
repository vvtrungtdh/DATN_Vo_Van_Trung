...
SDK/platform/drivers/src/flexcan/flexcan_driver.o: ../SDK/platform/drivers/src/flexcan/flexcan_driver.c
	...
	arm-none-eabi-gcc "@SDK/platform/drivers/src/flexcan/flexcan_driver.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "SDK/platform/drivers/src/flexcan/flexcan_driver.o" "$<"
...
SDK/platform/drivers/src/flexcan/flexcan_hw_access.o: ../SDK/platform/drivers/src/flexcan/flexcan_hw_access.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	arm-none-eabi-gcc "@SDK/platform/drivers/src/flexcan/flexcan_hw_access.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "SDK/platform/drivers/src/flexcan/flexcan_hw_access.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
SDK/platform/drivers/src/flexcan/flexcan_irq.o: ../SDK/platform/drivers/src/flexcan/flexcan_irq.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	arm-none-eabi-gcc "@SDK/platform/drivers/src/flexcan/flexcan_irq.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "SDK/platform/drivers/src/flexcan/flexcan_irq.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
